...
class BodyGenPolicyReconfig(Policy):
    def __init__(self, cfg, agent):
        ...
        self.action_dim = 2 * self.control_action_dim + self.attr_action_dim + 1
    ...
    def forward(self, x):
        stages = ['skel_trans', 'attr_trans', 'reconfig', 'execution']
    ...
    def select_action(self, x, mean_action=False):
        ...
        if attr_action is not None:
            action[node_design_mask['attr_trans'], 2 * self.control_action_dim: -1] = attr_action
    ...
    def get_log_prob(self, x, action):
        ...
        if attr_dist is not None:
            attr_action = action[node_design_mask['attr_trans'], 2*self.control_action_dim:-1]
